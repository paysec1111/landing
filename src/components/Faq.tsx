...
const FAQS = [
  {
    q: "What is PaySec?",
    a: "PaySec is a payment service provider giving you access to acquiring, local payment methods, and payouts across our supported markets through a single API.",
  },
  {
