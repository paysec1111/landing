...
const STORIES = [
  ...
  },
  {
    ...
    text: "Routes cross-border volume through PaySec instead of managing separate local banking relationships in every market.",
  },
  {
    n: "03",
    title: "A wallet automating payouts",
    text: "Sets payout rules once and lets PaySec settle user balances in USD on schedule, with manual override when needed.",
  },
];
  ...
  return (
    <Reveal className="border-b border-white/10 px-6 py-16 sm:px-10 md:px-16 md:py-24">
      ...
      <h2 className="m-0 mb-12 max-w-[900px] font-display font-extrabold uppercase leading-[1.05] text-[clamp(32px,7vw,52px)] sm:text-[clamp(32px,4.4vw,52px)] md:mb-14">
        Three ways teams put PaySec to work
      </h2>
